...
EosImportFiles::EosImportFiles(const std::string &configfile, const std::string& storageClass, bool retry,
  bool check, uint64_t skip)
  ...
  m_dbConnPool = ::std::make_unique<rdbms::ConnPool>(dbLogin, actual_max_num_conns);
